...
function readStash(buffer, mod, userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, readStashPart(stash, reader, mod, parseInt(stash.version))];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 1];
                case 4:
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, readStashPages(stash, reader, mod, parseInt(stash.version))];
                case 7:
                    _a.sent();
                    _a.label = 8;
...
function readStashPages(stash, reader, mod, version) {
    return __awaiter(this, void 0, void 0, function () {
        var i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, readStashPage(stash, reader, mod, version)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
...
function readStashPage(stash, reader, mod, version) {
    return __awaiter(this, void 0, void 0, function () {
        var page, header, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = page;
                    return [4 /*yield*/, items.readItems(reader, mod, version, defaultConfig)];
                case 1:
                    _a.items = _b.sent();
                    attribute_enhancer_1.enhanceItems(page.items, mod, version);
...
function readStashPart(stash, reader, mod, version) {
    return __awaiter(this, void 0, void 0, function () {
        var page, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
...
function writeStash(data, mod, version, userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, writeStashSection(data, page, mod, version, config)];
                case 2:
                    _c.apply(_b, [_h.sent()]);
                    _h.label = 3;
                case 3:
                ...
                case 6:
                    ...
                    return [4 /*yield*/, writeStashPages(data, mod, version, config)];
                case 7:
                    _g.apply(_f, [_h.sent()]);
                    _h.label = 8;
...
function writeStashSection(data, page, mod, version, userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, items.writeItems(page.items, mod, version, userConfig)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    size = writer.offset;
                    writer.SeekByte(16);
...
function writeStashPages(data, mod, version, config) {
    return __awaiter(this, void 0, void 0, function () {
        var writer, i, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _b = (_a = writer).WriteArray;
                    return [4 /*yield*/, writeStashPage(data.pages[i], mod, version, config)];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 3;
                case 3:
...
function writeStashPage(data, mod, version, config) {
    return __awaiter(this, void 0, void 0, function () {
        var writer, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _b = (_a = writer).WriteArray;
                    return [4 /*yield*/, items.writeItems(data.items, mod, version, config)];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/, writer.ToArray()];
            }
