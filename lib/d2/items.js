...
function writeItem(item, mod, version, config) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var constants, itemTypeDef, writer, i, magical_name_id, runeword_id, name_1, i, set_attribute_count, plist_flag, i, i, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    constants = constants_1.getConstantData(mod, version);
                    itemTypeDef = getItemTypeDef(item, constants);
                    ...
                    if (!item.simple_item) {
                        ...
                        //   _writeMagicProperties(writer, [], constants);
                        // } else {
...
function _writeMagicProperties(writer, properties, constants) {
    ...
    if (properties) {
        for (var i = 0; i < properties.length; i++) {
            ...
            var num_of_properties = ((_a = constants.magical_properties[property.id]) === null || _a === void 0 ? void 0 : _a.np) || 1;
