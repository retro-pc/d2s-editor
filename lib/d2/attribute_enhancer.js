...
function postProcessItem(item, constants) {
    ...
    if (item.magic_attributes || item.runeword_attributes || item.socketed_items || item.set_attributes) {
        ...
        item.displayed_set_attributes = (_a = item.set_attributes) === null || _a === void 0 ? void 0 : _a.map(function (set_attributes) { return describeMods(set_attributes, constants); });
    }
}
...
function describeSingleMod(mod, prop, constants) {
    ...
    if (!prop)
        return;
    //let val = mod.value;
    var val = mod.values[((_a = mod.values) === null || _a === void 0 ? void 0 : _a.length) - 1];
    ...
    switch (prop.dF) {
        ...
        case 14: // +[value] to [skilltab] Skill Levels ([class] Only)
            var skillTab = (_b = constants.classes[mod.values[1]]) === null || _b === void 0 ? void 0 : _b.ts[mod.values[0]];
            if (skillTab) {
        ...
        case 15: // [chance]% to cast [slvl] [skill] on [event]
            modDesc = modDesc
                ...
                .replace("%s", "" + ((_c = constants.skills[mod.values[1]]) === null || _c === void 0 ? void 0 : _c.n));
            break;
        case 16: // Level [sLvl] [skill] Aura When Equipped
            modDesc = modDesc.replace("%d", "" + val).replace("%s", "" + ((_d = constants.skills[mod.values[0]]) === null || _d === void 0 ? void 0 : _d.n));
            break;
        //todo
        ...
        case 27: // +[value] to [skill] ([class] Only)
            ...
            modDesc = formatStr(modDesc, val, skill_1 === null || skill_1 === void 0 ? void 0 : skill_1.n, (_e = constants.classes.filter(function (e) { return (e === null || e === void 0 ? void 0 : e.c) === (skill_1 === null || skill_1 === void 0 ? void 0 : skill_1.c); })[0]) === null || _e === void 0 ? void 0 : _e.co);
            break;
        case 28: // +[value] to [skill]
            modDesc = formatStr(modDesc, val, (_f = constants.skills[mod.values[0]]) === null || _f === void 0 ? void 0 : _f.n);
            break;
        ...
        case 100:
            ...
            modDesc = modDesc.replace("%d", "" + ((_j = mod.values) === null || _j === void 0 ? void 0 : _j[0])).replace("%d", "" + ((_k = mod.values) === null || _k === void 0 ? void 0 : _k[1]));
            break;
        case 101: // Poison damage
            if (((_l = mod.values) === null || _l === void 0 ? void 0 : _l[0]) === ((_m = mod.values) === null || _m === void 0 ? void 0 : _m[1])) {
                modDesc = modDesc
...
function formatStr(str) {
    ...
    var i = 0;
    var replaced = str === null || str === void 0 ? void 0 : str.replace(/%\+?d|%\+?s/gi, function (m) {
        var v = values[i++];
        if (m.indexOf('+') >= 0) {
            v = '+' + v;
        }
    ...
    // legacy strings
    if (replaced === str && values.length > 0) {
        return String('+' + values[0]) + (str ? ' ' + str : '');
    }
    return replaced;
}
