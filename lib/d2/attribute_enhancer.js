...
var ItemStatGroups_json_1 = __importDefault(require("../data/ItemStatGroups.json"));
var SkillTabs_json_1 = __importDefault(require("../data/SkillTabs.json"));
//do nice stuff
